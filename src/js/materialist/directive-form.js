...
/** simpan komentar aduan */
app.directive('saveAduanKomentar', ['$http', 'notify', function($http, notify) {
	return function($scope, elm, attrs) {
		elm.on('click', function(e) {
			$http.post('/post/aduan/komentar', { komentar: $('#report-komentar-id').val(), reason: $('#report-komentar-alasan').val() }).
			success(function(d) {
